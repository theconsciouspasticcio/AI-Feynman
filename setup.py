...
sr1 = Extension(
    name="aifeynman._symbolic_regress1", sources=["aifeynman/symbolic_regress1.f90"]
)

sr2 = Extension(
    name="aifeynman._symbolic_regress2", sources=["aifeynman/symbolic_regress2.f90"]
)

sr3 = Extension(
    name="aifeynman._symbolic_regress3", sources=["aifeynman/symbolic_regress3.f90"]
)
